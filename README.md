...
└── Neural_Network_Project/
    ...
    └── figures_paper/    # Figures for the paper
```
...
Each figure script in `figures/` loads the most recent matching result from `results/` and writes a PNG to `Neural_Network_Project/figures_paper/`. Run from the project root:
